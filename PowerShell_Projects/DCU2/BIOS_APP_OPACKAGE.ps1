...
function Install-ADTDeployment
{
    ...
    Function SetRegKey {
            # Culture-invariant ISO 8601 sortable stamp (e.g. 2026-06-04T15:30:45).
            # MUST match the format the PR detection script parses with InvariantCulture.
            # Previously 'Get-Date -Format G', which rendered in the writing process's
            # culture (en-US under SYSTEM, en-GB locally) and broke the en-GB parser.
